...
versioning. The repository-root module uses `v<version>` tags. Independently
...
[specification decision register](docs/specification-decisions.md) is the
authority for bounded conformance and deliberate interoperability differences.
