...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-merkle-patricia-trie" &&
                "${module_path}" != github.com/faustbrian/go-merkle-patricia-trie/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-merkle-patricia-trie"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
